...
public class StatsView extends Sprite {
    ...
    public static const CRITRATE:int = 6;
    public static const CRITPOWER:int = 7;
    ...
    private function drawStats(_arg_1:Player):void {
        ...
        this.stats_[CRITRATE].draw(_arg_1.critRate_,_arg_1.critRateBoost_,_arg_1.critRateMax_);
        this.stats_[CRITPOWER].draw(_arg_1.critPower_,_arg_1.critPowerBoost_,_arg_1.critPowerMax_);
    }
