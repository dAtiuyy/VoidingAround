...
public class StatData {
    ...
    public static const CRIT_RATE_STAT:int = 99;
    public static const CRIT_POWER_STAT:int = 100;
    public static const CRIT_RATE_BOOST_STAT:int = 101;
    public static const CRIT_POWER_BOOST_STAT:int = 102;
    ...
    public static function statToName(_arg_1:int):String {
        switch (_arg_1) {
            ...
            case CRIT_RATE_STAT:
                return TextKey.STAT_MODEL_CRITRATE_LONG;
            case CRIT_POWER_STAT:
                return TextKey.STAT_MODEL_CRITPOWER_LONG;
        }
