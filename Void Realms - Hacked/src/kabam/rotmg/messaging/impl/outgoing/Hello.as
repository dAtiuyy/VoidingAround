...
public class Hello extends OutgoingMessage {
    ...
    override public function toString():String {
        return (formatToString("HELLO", "buildVersion_", "gameId_", "guid_", "password_", "secret_", "loadInfo_"));
    }
