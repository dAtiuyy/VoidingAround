...
public class EnemyHit extends OutgoingMessage {
    ...
    public var CriticalHit_:Boolean;
    ...
    override public function writeToOutput(_arg_1:IDataOutput):void {
        ...
        _arg_1.writeBoolean(this.CriticalHit_);
        _arg_1.writeInt(this.damage_);
    }

    override public function toString():String {
        return formatToString("ENEMYHIT","time_","bulletId_","targetId_","kill_","CriticalHit_");
    }
