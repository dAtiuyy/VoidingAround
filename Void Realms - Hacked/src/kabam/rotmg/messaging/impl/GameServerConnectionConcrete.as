...
public class GameServerConnectionConcrete extends GameServerConnection {
    ...
    override public function playerHit(_arg_1:int, _arg_2:int):void {
        ...
        Parameters.data_["Hits"] +=1;
        if(!(Parameters.data_.GodMode && Parameters.data_.masterGod)){
            serverConnection.sendMessage(_local_3);
        }
    }

    override public function enemyHit(_arg_1:int, _arg_2:int, _arg_3:int, _arg_4:Boolean, _arg_5:Boolean, _arg_6:int): void
    {
        ...
        _local_5.CriticalHit_ = _arg_5;
        _local_5.damage_ = _arg_6;
    ...
    private function onConnected():void {
        ...
        _local_2.loadInfo = "www.void-realm.com";//webmain.stage.loaderinfo.url
        serverConnection.sendMessage(_local_2);
    }
        ...
        for each (_local_7 in _arg_2) {
            ...
            switch (_local_7.statType_) {
                ...
                case StatData.DEXTERITY_BOOST_STAT:
                    ...
                    break;
                case StatData.CRIT_RATE_STAT:
                    _local_4.critRate_ = _local_8;
                    break;
                case StatData.CRIT_RATE_BOOST_STAT:
                    _local_4.critRateBoost_ = _local_8;
                    break;
                case StatData.CRIT_POWER_STAT:
                    _local_4.critPower_ = _local_8;
                    break;
                case StatData.CRIT_POWER_BOOST_STAT:
                    _local_4.critPowerBoost_ = _local_8;
                    break;
