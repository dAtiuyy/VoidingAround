...
public class Parameters {
    ...
    public static var CLIENT_VERSION:String = "2018.p0.20.###1";
    ...
    public static var masterOptions:Boolean = false;
    ...
    public static function setDefaults():void {
        ...
        setDefaultKey("tpKey", KeyCodes.F);
        setDefaultKey("tqKey", KeyCodes.J);

        //Master Hack Options
        setDefault("masterGod", true);
        setDefault("masterDex", false);
        setDefault("masterStacked", true);

        //No-Debuff Options
        setDefault("slowed", false);
        setDefault("dazed", false);
        setDefault("stunned", false);
        setDefault("blind", false);
        setDefault("drunk", false);
        setDefault("confused", false);
        setDefault("paralyzed", false);
        setDefault("hallucinating", false);
        setDefault("unstable", false);
        setDefault("darkness", false);
