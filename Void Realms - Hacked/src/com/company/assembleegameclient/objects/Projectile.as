...
public class Projectile extends BasicObject {
    ...
    override public function update(_arg_1:int, _arg_2:int):Boolean {
        ...
        var boost_:int = (Parameters.data_.RangeHax && (this.ownerId_ == map_.player_.objectId_)) ? 1000 : 0;
        var _local_3:int = (_arg_1 - this.startTime_);
        if (_local_3 > this.projProps_.lifetime_ + boost_) {
            return (false);
        }
        ...
        if (((((!((square_.obj_ == null))) && (((!(square_.obj_.props_.isEnemy_)) || (!(this.damagesEnemies_)))))) && (((square_.obj_.props_.enemyOccupySquare_) || (((!(this.projProps_.passesCover_)) && (square_.obj_.props_.occupySquare_))))))) {
            if (this.damagesPlayers_) {
                ...
                if((Parameters.data_.ProjNoClip) && (this.ownerId_ == map_.player_.objectId_)) return true;
                _local_5 = BloodComposition.getColors(this.texture_);
                map_.addObj(new HitEffect(_local_5, 100, 3, this.angle_, this.projProps_.speed_), _local_4.x, _local_4.y);
            }
            return (false);
        ...
        if (_local_6 != null) {
            ...
            if (_local_10) {
                ...
                if (_local_6 == _local_7) {
                    ...
                    if (_local_6.props_.isEnemy_) {
                        var ss:Number = 0;
                        var Max:Number = (Parameters.data_.StackedShots && Parameters.data_.masterStacked) ? Parameters.data_.ss : 1;
                        while (ss < Max) {
                            ss++;
                            var _critHit:Boolean = (Math.random() * 100 < _local_7.critRate_);
                            var _critPower:Number = _local_7.critPower_ * 3 / 100 + 1.17
                            var _damage:Number = _critHit ? _local_11 * _critPower : _local_11;
                            map_.gs_.gsc_.enemyHit(_arg_1, this.bulletId_, _local_6.objectId_, _local_12, _critHit, _damage);
                            if(ss < 15){
                                _local_6.damage(this.containerType_, _damage, this.projProps_.effects_, _local_12, this, _critHit);
                            }
                        }
                        /*if(Math.random() * 100 >= _local_7.critRate_)
                        {
                            map_.gs_.gsc_.enemyHit(_arg_1,this.bulletId_,_local_6.objectId_,_local_12,false,_local_11);
                            _local_6.damage(this.containerType_,_local_11,this.projProps_.effects_,_local_12,this,false);
                        }
                        else
                        {
                            _local_20 = _local_7.critPower_ * 3 / 100 + 1.17;
                            map_.gs_.gsc_.enemyHit(_arg_1,this.bulletId_,_local_6.objectId_,_local_12,true,int(_local_11 * _local_20));
                            _local_6.damage(this.containerType_,_local_11 * _local_20,this.projProps_.effects_,_local_12,this,true);
                        }*/
                    }
                    else {
        ...
        for each (_local_5 in map_.goDict_) {
            if (!_local_5.isInvincible()) {
                if (!_local_5.isStasis()) {
                    if (((((this.damagesEnemies_) && (_local_5.props_.isEnemy_))) || (((this.damagesPlayers_) && (_local_5.props_.isItem_))))) {
