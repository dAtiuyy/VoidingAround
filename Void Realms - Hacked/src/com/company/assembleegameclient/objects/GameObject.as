...
public class GameObject extends BasicObject {
    ...
    public function isPaused():Boolean {
        return false;//(!(((this.condition_[ConditionEffect.CE_FIRST_BATCH] & ConditionEffect.PAUSED_BIT) == 0)));
    }
    ...
    public function damage(_arg_1:int, _arg_2:int, _arg_3:Vector.<uint>, _arg_4:Boolean, _arg_5:Projectile, _arg_6:Boolean=false):void {
        var _local_7:int;
        var _local_8:uint;
        ...
        if (!((this.props_.isEnemy_) && (Parameters.data_.disableEnemyParticles || Parameters.data_.StackedShots))) {
        ...
        if (_arg_2 > 0) {
            ...
            if(_arg_6)
            {
                this.showCritDamageText(_arg_2);
            }
            else
            {
    ...
    public function showCritDamageText(_arg_1:int) : void
    {
        var _local_3:String = "-" + _arg_1;
        var _local_4:CharacterStatusText = new CharacterStatusText(this,16737536,1300);
        _local_4.setStringBuilder(new StaticStringBuilder(_local_3));
        map_.mapOverlay_.addStatusText(_local_4);
    }
